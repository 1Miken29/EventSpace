    ...
    <>
      ...
      <Sheet open={openAddSheet} onOpenChange={setOpenAddSheet}>
        <SheetContent className="min-w-1/2">
          <AddRoom modalClose={setOpenAddSheet} />
        </SheetContent>
      </Sheet>
      <Sheet open={openEditSheet} onOpenChange={setOpenEditSheet}>
        <SheetContent className="min-w-1/2">
          <EditRoom modalClose={setOpenEditSheet} />
        </SheetContent>
      </Sheet>
      <AlertDialog open={openDialog} onOpenChange={setOpenDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Se mostrará tu salón en la aplicación móvil y podrás recibir
              reservas y comentarios de clientes
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
